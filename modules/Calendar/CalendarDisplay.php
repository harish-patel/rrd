...
class CalendarDisplay {
	...
	protected function get_next_calendar(){
		...
		$str .= "&nbsp;&nbsp;".SugarThemeRegistry::current()->getImage("calendar_next", 'align="absmiddle" border="0"' ,null,null,'.png', '') . "</a>"; //setting alt tag blank on purpose for 508 compliance
		return $str;
	}
	...
	protected function get_previous_calendar(){
		...
		$str .= SugarThemeRegistry::current()->getImage('calendar_previous','align="absmiddle" border="0"', null, null, '.png', ''); //setting alt tag blank on purpose for 508 compliance
